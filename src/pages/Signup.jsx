      ...
      <nav className="auth-nav content-layer" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
            Already have an account? <Link to="/login" style={{ color: 'var(--indigo)', fontWeight: 500 }}>Sign in →</Link>
          </div>
        </div>
      </nav>
      ...
      <div className="auth-wrap content-layer">
        <div className="auth-visual">
          ...
          <div className="auth-visual-text">
            ...
            <h2>Let the path find you.</h2>
            <p>Join a community of learners experiencing the first truly adaptive curriculum engine powered by deep reinforcement learning.</p>
            <div className="auth-quote">
              <p>"I stopped worrying about what to learn next. I just show up, AdaptivePath gives me the optimal challenge, and my retention has skyrocketed."</p>
              <div className="auth-quote-author">
                <div className="auth-quote-av">JD</div>
                <div>
                  <strong style={{ color: 'var(--text)', fontSize: '12px' }}>James D.</strong><br />
        ...
        <div className="auth-form-side">
          <div className="auth-card-wrap">
            ...
            <div className="auth-footer-link">By signing up, you agree to our <a href="#">Terms of Service</a></div>
          </div>
        </div>
      </div>
    </div>
